...
public class ChoreoTrajectoryFollower {
    ...
    // This is similar to the usual choreoSwerveCommand but it does not sent outputTrajectoryStates to the drivetrain itself. Allows for feedforward control.
    ...
    public static Command customChoreoSwerveAuto(
        String choreoTrajectoryName,
        String pathPlannerAutoName
    ) {
