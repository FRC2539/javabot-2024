...
public final class Constants {
    ...
    public static final class ShooterConstants {
        ...
        public static final InterpolatingMap<InterpolatableDouble> shooterAngleMap() {
            ...
            map.put(4.862, new InterpolatableDouble(28));
            map.put(5.158, new InterpolatableDouble(27.5));
            map.put(5.406, new InterpolatableDouble(26.0));
            map.put(5.541, new InterpolatableDouble(25.25));
            map.put(5.9, new InterpolatableDouble(24.5));
    ...
    public static class SwerveConstants {
        ...
        public static final int drivePeakCurrentLimit = 90;
    ...
    public static final class VisionConstants {
        ...
        public static final Transform3d limelightRobotToCamera = new Transform3d(
                new Translation3d(0, 0, .25), new Rotation3d(Math.toRadians(180), Math.toRadians(36), 0));
